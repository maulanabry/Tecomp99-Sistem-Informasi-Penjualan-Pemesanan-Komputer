            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div class="text-center lg:text-left">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <a href="/products" class="bg-white text-primary-600 px-8 py-4 rounded-full font-semibold hover:bg-gray-100 transition-all duration-300 text-center hover:shadow-xl hover:scale-105">
                            <i class="fas fa-shopping-bag mr-2"></i>Belanja Sekarang
                        </a>
                        <a href="/services" class="border-2 border-white/30 bg-white/10 backdrop-blur-sm text-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-primary-600 transition-all duration-300 text-center">
                ...
                <div>
                    <div class="bg-white rounded-lg shadow-lg p-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <a href="https://wa.me/6281336766761" class="text-green-600 hover:text-green-700">0813-3676-6761</a>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <a href="https://instagram.com/tecomp99" class="text-pink-600 hover:text-pink-700">@tecomp99</a>
                                </div>
                            </div>
                        ...
                        <div class="mt-6 pt-6 border-t">
                            <a href="https://maps.google.com/?q=Jl.+Manyar+Sabrangan+IX+D+No.9+Surabaya" target="_blank" class="inline-flex items-center text-primary-600 hover:text-primary-700 font-medium">
