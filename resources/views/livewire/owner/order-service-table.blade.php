            ...
            @forelse ($orderServices as $order)
                ...
                <div class="hidden md:grid grid-cols-10 gap-4 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="col-span-1 text-center">
                        <x-action-dropdown>
                            <a href="{{ route('pemilik.order-service.show', $order->order_service_id) }}" class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700" role="menuitem">
                            ...
                            @endif
                            @if(!in_array($order->status_order, ['Selesai', 'Dibatalkan']))
                                <a href="{{ route('pemilik.order-service.edit', $order->order_service_id) }}" class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700" role="menuitem">
                                    <svg class="mr-3 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
