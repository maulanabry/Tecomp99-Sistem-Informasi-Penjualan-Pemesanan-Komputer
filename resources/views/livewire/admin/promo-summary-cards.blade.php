<div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-6" wire:poll.60000ms>
    ...
    <div class="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:shadow-lg transition-shadow">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ $totalPromo }}</h3>
            </div>
    ...
    <div class="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:shadow-lg transition-shadow">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h3 class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ $promoAktif }}</h3>
            </div>
    ...
    <div class="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:shadow-lg transition-shadow">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Promo Tidak Aktif</p>
                <h3 class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ $promoTidakAktif }}</h3>
            </div>
    ...
    <div class="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-4 hover:shadow-lg transition-shadow">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Promo Terhapus</p>
                <h3 class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ $promoTerhapus }}</h3>
                @if($promoTerhapus > 0)
                    <a href="{{ route('promos.recovery') }}" wire:navigate class="inline-flex items-center mt-2 text-sm font-medium text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">
                        Pulihkan
