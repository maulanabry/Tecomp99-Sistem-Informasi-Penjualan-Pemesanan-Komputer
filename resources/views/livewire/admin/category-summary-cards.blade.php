        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                @if($kategoriTerhapus > 0)
                    <a href="{{ route('categories.recovery') }}" class="inline-flex items-center mt-2 text-sm font-medium text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300">
                        Pulihkan
