<div class="p-6 mx-auto bg-white dark:bg-gray-800 rounded-lg shadow">
    ...
    <form wire:submit.prevent="submit" class="space-y-6">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                @if ($customer_id)
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-md">
                        <p class="mb-2"><strong>Email:</strong> {{ $selectedCustomer->email ?? '-' }}</p>
                        <p class="mb-2"><strong>Nomor HP:</strong> {{ $selectedCustomer->contact ?? '-' }}</p>
        ...
        <div class=" p-6 rounded-lg  grid grid-cols-2 gap-6">
            <div>
