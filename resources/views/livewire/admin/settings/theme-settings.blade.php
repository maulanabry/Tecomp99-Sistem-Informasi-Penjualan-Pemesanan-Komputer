<div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Personalisasi Tampilan</h3>
    ...
    <form wire:submit="updateTheme" class="space-y-4">
        <div class="space-y-3">
            ...
            <div class="flex items-center">
                <input type="radio" id="light" wire:model="theme" value="light"
                ...
                <label for="light" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                    <div class="flex items-center">
            ...
            <!-- Dark Theme Option -->
            <div class="flex items-center">
                <input type="radio" id="dark" wire:model="theme" value="dark"
                    class="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
                <label for="dark" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                    <div class="flex items-center">
                        <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
            ...
            <!-- System Theme Option -->
            <div class="flex items-center">
                <input type="radio" id="system" wire:model="theme" value="system"
                    class="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
                <label for="system" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                    <div class="flex items-center">
                        <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
