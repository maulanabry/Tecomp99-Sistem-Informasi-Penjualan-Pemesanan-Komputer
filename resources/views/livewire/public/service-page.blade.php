<div>
    <div class="min-h-screen bg-gray-50/50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-medium text-gray-900">Servis</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <!-- Page Title -->
            <div class="mb-8">
                <h1 class="text-4xl font-bold text-gray-900 mb-3">Servis</h1>
                <p class="text-lg text-gray-600">Temukan layanan servis komputer dan IT terbaik untuk kebutuhan Anda</p>
            </div>

            <!-- Flash Messages -->
            @if (session()->has('service-message'))
                <div class="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                    <div class="flex items-center">
                        <i class="fas fa-check-circle text-green-500 mr-2"></i>
                        <span class="text-green-800">{{ session('service-message') }}</span>
                    </div>
                </div>
            @endif
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8">
                ...
                <div class="lg:col-span-1">
                    ...
                    <div id="mobile-filters" class="hidden lg:block bg-white rounded-2xl shadow-sm border border-gray-100 p-4 lg:p-6 lg:sticky lg:top-6">
                        <div class="flex items-center justify-between mb-6">
                            <h3 class="text-lg font-semibold text-gray-900">Filter Servis</h3>
                        ...
                        <!-- Search Bar -->
                        <div class="mb-6">
                            <label for="search" class="block text-sm font-medium text-gray-700 mb-2">Cari Servis</label>
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    placeholder="Cari berdasarkan nama servis"
                                >
                            </div>
                        </div>
                ...
                <!-- Right Content - Service Listing -->
                <div class="lg:col-span-3">
                    
                    <!-- Sorting and Results Count -->
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-4">
                        <div class="text-sm text-gray-600">
                            <span class="font-medium">{{ $services->count() }}</span> dari <span class="font-medium">{{ $services->total() }}</span> servis ditemukan
                        </div>
                    ...
                    <!-- Services Grid - Changed to 2 columns -->
                    @if($services->count() > 0)
                    ...
                    @else
                        ...
                        <div class="text-center py-20">
                            ...
                            <h3 class="text-2xl font-semibold text-gray-900 mb-3">Servis tidak ditemukan</h3>
                            <p class="text-gray-500 mb-8 max-w-md mx-auto">Coba ubah filter pencarian atau kata kunci Anda untuk menemukan layanan yang sesuai</p>
                            <button 
                                wire:click="clearFilters"
    ...
    <script>
        ...
        document.addEventListener('livewire:init', () => {
            Livewire.on('service-booked', (serviceId) => {
                // You can add custom service booking logic here
