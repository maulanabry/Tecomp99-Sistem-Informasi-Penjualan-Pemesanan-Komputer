        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div class="flex items-center justify-start">
                    <a href="{{ route('pemilik.dashboard.index') }}" wire:navigate class="flex ml-2 md:mr-24 items-center gap-3">
                        <img class="h-10 w-auto" src="/images/logo-tecomp99.svg" alt="logo">
                        <!-- Owner Panel Title, hidden on mobile -->
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="hidden md:flex items-center space-x-3">
                        <div class="text-right">
                            <div class="text-sm font-medium text-neutral-700 dark:text-white">{{ auth('pemilik')->user()->name }}</div>
                            <div class="text-xs text-neutral-500 dark:text-neutral-400">{{ ucfirst(auth('pemilik')->user()->role) }}</div>
                        </div>
