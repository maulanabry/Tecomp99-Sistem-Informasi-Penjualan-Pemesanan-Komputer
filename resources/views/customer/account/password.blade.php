            ...
            <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                <a href="{{ route('customer.account.profile') }}" class="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-200">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-gray-900">Kembali ke Profil</h3>
                            <p class="text-xs text-gray-500">Edit informasi profil Anda</p>
                        </div>
                    </div>
                </a>

                <a href="{{ route('customer.account.addresses') }}" class="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-200">
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <i class="fas fa-map-marker-alt text-primary-500 text-xl"></i>
                        </div>
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-gray-900">Kelola Alamat</h3>
                            <p class="text-xs text-gray-500">Tambah atau edit alamat pengiriman</p>
                        </div>
                    </div>
                </a>
            </div>
