    ...
    <div class="py-6">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Data Master Pelanggan</h1>
                <div class="flex space-x-3">
                    <a href="{{ route('customers.recovery') }}" 
            ...
            <div class="py-4">
                ...
                <form method="GET" action="{{ route('customers.index') }}" class="mb-6">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                        ...
                        <!-- Account Filter -->
                        <div>
                            <select name="hasAccount" class="block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 pr-10 focus:border-primary-500 dark:text-gray-200 shadow-sm focus:ring-primary-500 sm:text-sm">
                                <option value="">Semua Status Akun</option>
                                <option value="1" {{ request('hasAccount') === '1' ? 'selected' : '' }}>Memiliki Akun</option>
                                <option value="0" {{ request('hasAccount') === '0' ? 'selected' : '' }}>Tidak Memiliki Akun</option>
                            </select>
                        </div>
                    ...
                    <div class="hidden md:block">
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-t-lg">
                            <div class="grid gap-4 px-6 py-3" style="grid-template-columns: 50px 100px 2fr 2fr 1fr 1fr 1.5fr 2fr 100px">
                                ...
                                <div class="text-left text-sm font-semibold text-gray-900 dark:text-gray-100">{!! sortLink('customer_id', 'ID', $sort, $direction) !!}</div>
                                <div class="text-left">{!! sortLink('name', 'Nama', $sort, $direction) !!}</div>
                                <div class="text-left">{!! sortLink('email', 'Email', $sort, $direction) !!}</div>
                                <div class="text-left">{!! sortLink('contact', 'No HP', $sort, $direction) !!}</div>
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex justify-end items-center gap-2 mt-4">
                                        ...
                                        <a href="{{ $customer->whatsapp_link }}" 
                                            target="_blank"
                                            class="inline-flex items-center gap-1 rounded-md bg-green-600 hover:bg-green-700 px-3 py-2 text-xs font-semibold text-white shadow-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
