<x-layout-admin>
    <div class="py-6">
        @if (session('success'))
            ...
            <script>
                // Ensure Livewire components refresh after successful customer creation
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Manajemen Pelanggan</h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 ">
            <div class="py-4">
                @livewire('admin.customer-summary-cards')
            </div>
            <div class="py-4"> 
