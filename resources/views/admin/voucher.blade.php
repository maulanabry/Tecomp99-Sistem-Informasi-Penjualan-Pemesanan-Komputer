    ...
    <div class="py-6">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Manajemen Voucher</h1>
                <div class="flex flex-col sm:flex-row sm:space-x-3 space-y-3 sm:space-y-0">
                    <a href="{{ route('vouchers.recovery') }}" 
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            <div class="py-4">
                @livewire('admin.voucher-summary-cards')
            </div>
            <div class="py-4"> 
