    ...
    <div class="py-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                        ...
                        <div class="p-6">
                            <form action="{{ route('order-services.update-status', $orderService) }}" method="POST" class="flex flex-wrap items-end gap-4">
                                @csrf
                                @method('PUT')
        ...
        <select name="status_order" id="status_order" required
            ...
            <option value="dibatalkan" {{ $orderService->status_order === 'dibatalkan' ? 'selected' : '' }}>Dibatalkan</option>
                    ...
                    <!-- Service Tickets -->
                    <div id="service-tickets" class="mt-6 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-600">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="mt-6 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <div class="p-6 space-y-3">
                            @if($orderService->tickets->isNotEmpty())
                                <a href="{{ route('service-tickets.show', $orderService->tickets->first()) }}"
                                    class="w-full inline-flex items-center justify-center px-4 py-2 border border-blue-300 shadow-sm text-sm font-medium rounded-md text-blue-700 bg-white hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 dark:bg-gray-700 dark:border-blue-600 dark:text-blue-400 dark:hover:bg-blue-900/20">
                                    <i class="fas fa-ticket-alt mr-2"></i>
                                    Lihat Tiket Servis
                                </a>
