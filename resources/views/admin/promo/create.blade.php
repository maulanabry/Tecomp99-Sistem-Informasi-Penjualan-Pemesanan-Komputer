<x-layout-admin>
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Tambah Promo</h1>
        </div>

        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            <div class="py-4">
                <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
                    <form action="{{ route('promos.store') }}" method="POST" class="space-y-6 p-6">
                        @csrf
                        ...
                        <div x-data="{ type: '{{ old('type', 'percentage') }}' }">
                            <!-- Type -->
                            <div>
                        ...
                        <div>
                            <div class="flex items-center">
                                <input type="checkbox" name="is_active" id="is_active" value="1" 
                                    {{ !is_null(old('is_active')) ? (old('is_active') ? 'checked' : '') : 'checked' }}
