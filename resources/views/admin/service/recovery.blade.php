    ...
    <div class="py-6">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Pemulihan Servis</h1>
                <a href="{{ route('services.index') }}" class="inline-flex items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 sm:w-auto dark:bg-gray-800 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            <div class="py-4">
                ...
                <form method="GET" action="{{ route('services.recovery') }}" class="mb-6">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        ...
                        <div class="relative rounded-md shadow-sm">
                            <input type="text" name="search" value="{{ request('search') }}" 
                                ...
                                placeholder="Cari servis terhapus...">
                            ...
                            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-300 dark:divide-gray-600">
                                    <thead class="bg-gray-50 dark:bg-gray-700">
                                        <tr>
                                            <th class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-gray-100">Thumbnail</th>
                                    ...
                                    <tbody class="divide-y divide-gray-200 dark:divide-gray-600 bg-white dark:bg-gray-800">
                                        ...
                                        <tr>
                                            <td class="whitespace-nowrap px-3 py-4 text-sm">
                                                @if($service->thumbnail)
                                                    <img src="{{ asset($service->thumbnail) }}" alt="{{ $service->name }}" class="h-10">
                                                @else
                                            ...
                                            <td class="whitespace-nowrap px-3 py-4 text-sm text-center">
                                                <div class="flex justify-center space-x-2">
                                                    <button type="button"
                                                        data-modal-target="restore-modal-{{ $service->service_id }}"
                                                        data-modal-toggle="restore-modal-{{ $service->service_id }}"
                                                    ...
                                                    <button type="button"
                                                        data-modal-target="permanent-delete-modal-{{ $service->service_id }}"
                                                        data-modal-toggle="permanent-delete-modal-{{ $service->service_id }}"
                                                    ...
                                                    <x-restore-confirmation-modal 
                                                        ...
                                                        :action="route('services.restore', $service->service_id)"
                                                        message="Apakah Anda yakin ingin memulihkan servis ini?"
                                                        :itemName="$service->name"
                                                    />

                                                    <x-permanent-delete-confirmation-modal 
                                                        :id="$service->service_id"
                                                        :action="route('services.force-delete', $service->service_id)"
                                                        message="Apakah Anda ingin menghapus servis ini secara permanen?"
                                                        :itemName="$service->name"
                                                    />
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="6" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 text-center">
                                                Tidak ada servis yang terhapus.
                                            </td>
                                        </tr>
                                        @endforelse
                                    </tbody>
