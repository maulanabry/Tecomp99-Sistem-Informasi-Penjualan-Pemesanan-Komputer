<x-layout-admin>
    ...
    <div class="max-w-7xl mx-auto p-6" x-data="orderProductForm()">
        @if (session('success'))
            <div class="mb-4">
            ...
            <div class="flex gap-4">
                <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 w-2/4">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Admin dapat mengubah jumlah diskon secara manual (gunakan format: 10.000)</p>
                    </div>
