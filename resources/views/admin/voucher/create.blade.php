    ...
    <div class="py-6">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Tambah Voucher</h1>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('vouchers.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="border-b border-gray-200 dark:border-gray-600 pb-6" x-data="{ type: '{{ old('type', 'percentage') }}' }">
                            <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100 mb-4">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="relative">
                                        <input id="type_percentage" name="type" type="radio" value="percentage" 
                                            x-model="type" {{ old('type', 'percentage') === 'percentage' ? 'checked' : '' }}
                                            class="sr-only">
                                    ...
                                    <div class="relative">
                                        <input id="type_amount" name="type" type="radio" value="amount" 
                                            x-model="type" {{ old('type') === 'amount' ? 'checked' : '' }}
                                            class="sr-only">
