<x-layout-owner>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                ...
                <div class="flex space-x-3">
                    <a href="{{ route('pemilik.order-service.edit', $orderService) }}" 
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                        ...
                        <div class="p-6">
                            <form action="{{ route('pemilik.order-service.update-status', $orderService) }}" method="POST" class="flex flex-wrap items-end gap-4">
                                @csrf
                                @method('PUT')
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <div class="p-6 space-y-3">
                            ...
                            @if($orderService->paymentDetails->isEmpty())
                                <a href="{{ route('owner.payments.create') }}?order_service_id={{ $orderService->id }}"
                            ...
                            <a href="{{ route('pemilik.order-service.invoice', $orderService) }}"
                            ...
                            @if($orderService->device)
                                <a href="{{ route('pemilik.order-service.tanda-terima', $orderService) }}"
                                    class="w-full inline-flex items-center justify-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-600">
    ...
    <x-cancel-order-modal
        ...
        :action="route('pemilik.order-service.cancel', $orderService)"
    />
