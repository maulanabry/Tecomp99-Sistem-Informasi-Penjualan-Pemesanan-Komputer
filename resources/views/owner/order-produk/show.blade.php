<x-layout-owner>
                        ...
                        <div class="p-6">
                            <dl class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-primary-600 dark:text-primary-400 font-semibold">
                                        <i class="fas fa-user mr-1"></i>{{ $orderProduct->customer->name }}
                                    </dd>
                                </div>
                                <div>
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <div class="p-6 space-y-3">
                            ...
                            @if($orderProduct->payments->isEmpty())
                                <a href="{{ route('owner.payments.create') }}?order_product_id={{ $orderProduct->id }}"
    ...
    <x-cancel-order-modal
        ...
        :action="route('pemilik.order-produk.cancel', $orderProduct)"
    />
</x-layout-owner>
