            ...
            <div class="flex gap-4">
                <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6 w-2/4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="discount_amount" name="discount_amount_display"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            value="{{ number_format($orderProduct->discount_amount ?? 0, 0, ',', '.') }}"
                            data-currency="true">
                        <input type="hidden" id="discount_amount_hidden" name="discount_amount" value="{{ $orderProduct->discount_amount ?? 0 }}" />
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Pemilik dapat mengubah jumlah diskon secara manual. Gunakan format: 10.000 untuk sepuluh ribu</p>
                    </div>
