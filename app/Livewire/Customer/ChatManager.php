...
class ChatManager extends Component
{
    ...
    public function mount()
    {
        ...
        // Jika ada chat aktif, load chat tersebut
        $activeChat = Auth::guard('customer')->user()->chats()
    ...
    public function selectAdmin($adminId)
    {
        ...
        $this->currentChat = $customer->getChatWithAdmin($adminId);
    ...
    // Method untuk polling real-time updates
    ...
    {
        return view('livewire.customer.chat-manager');
    }
}
