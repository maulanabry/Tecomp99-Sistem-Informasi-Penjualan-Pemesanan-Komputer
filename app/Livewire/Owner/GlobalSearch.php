...
class GlobalSearch extends Component
{
        ...
        $orderProducts = OrderProduct::where('order_product_id', 'like', $query)
            ...
            ->map(function ($order) {
                return [
                    ...
                    'type' => 'order_product',
                    'url' => route('pemilik.order-produk.show', $order->order_product_id)
                ];
            });
        ...
        $serviceOrders = OrderService::where('order_service_id', 'like', $query)
            ...
            ->map(function ($order) {
                return [
                    ...
                    'subtitle' => 'Status: ' . $order->status_order . ' - ' . $order->customer->name,
                    'type' => 'order_service',
                    'url' => route('pemilik.order-service.show', $order->order_service_id)
                ];
            });
    ...
    {
        return view('livewire.owner.global-search');
    }
}
